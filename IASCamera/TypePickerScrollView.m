...
@interface TypePickerScrollView ()<UIScrollViewDelegate>



@end

@implementation TypePickerScrollView
...
- (void)layoutItems
{
    ...
    for (int i = 0; i < self.items.count; i++) {
        TypePickerItem *item = [self.items objectAtIndex:i];
...
{
    // remove
    for (TypePickerItem *item in self.items) {
...
- (void)itemInCenterChange:(TypePickerItem*)item
{
...
- (void)itemInCenterBack:(TypePickerItem*)item
{
